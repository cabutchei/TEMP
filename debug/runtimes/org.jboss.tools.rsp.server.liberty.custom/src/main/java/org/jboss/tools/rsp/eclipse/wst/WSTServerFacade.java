...
public class WSTServerFacade {
	...
	public void createServer(IServerType serverType, String id, Map<String, Object> attributes) {
		// Create a WST server instance based on the RSP server type and attributes
		// This is a placeholder implementation; actual implementation would depend on WST APIs
		...
		try {
			...
			runtimeWC.setLocation(new org.eclipse.core.runtime.Path("/Users/cabutchei/wlp"));
			org.eclipse.wst.server.core.IRuntime run;
			run = runtimeWC.save(true, monitor);
			org.eclipse.wst.server.core.IServerWorkingCopy server = wstServerType.createServer(null, null, run, monitor);
