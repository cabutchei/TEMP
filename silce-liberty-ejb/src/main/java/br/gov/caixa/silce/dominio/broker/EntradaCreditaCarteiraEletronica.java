...
public class EntradaCreditaCarteiraEletronica implements EntradaBroker<RetornoCreditaCarteiraEletronica> {
	...
	private final OperacaoSidmo operacao;

	public EntradaCreditaCarteiraEletronica(OperacaoSidmo operacao) {
