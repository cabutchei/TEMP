...
public class CEPValueHandler extends AbstractValueHandler {

	public static final String STRATEGY_NAME = "br.gov.caixa.silce.dominio.openjpa.CEPValueHandler";
	...
	public Object toDataStoreValue(ValueMapping vm, Object val, JDBCStore store) {
		return toDataStoreValue((CEP) val);
	}

	private String toDataStoreValue(CEP value) {
		if (value == null) {
			return null;
		}

		return value.getCepSemMascara();
	}
	...
	private CEP toObjectValue(String value) {
		if (value == null) {
			return null;
		}
