...
public class HoraValueHandler extends AbstractValueHandler {

	public static final String STRATEGY_NAME = "br.gov.caixa.silce.dominio.openjpa.HoraValueHandler";
	...
	public Object toDataStoreValue(ValueMapping vm, Object val, JDBCStore store) {
		return toDataStoreValue((Hora) val);
	}

	private Date toDataStoreValue(Hora value) {
		if (value == null) {
			return null;
		}
	...
	private Hora toObjectValue(Date value) {
		if (value == null) {
			return null;
		}
