 ...
 *
 */
public class PalpitesLotogolValueHandler extends AbstractValueHandler {

	public static final String STRATEGY_NAME = "br.gov.caixa.silce.dominio.openjpa.PalpitesLotogolValueHandler";
	...
	private Palpites toObjectValue(String value) {
		...
		return new PalpitesLotogol(value);
