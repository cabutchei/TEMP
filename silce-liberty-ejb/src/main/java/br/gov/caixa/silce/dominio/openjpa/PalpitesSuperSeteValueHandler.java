...
public final class PalpitesSuperSeteValueHandler extends AbstractValueHandler {

	public static final String STRATEGY_NAME = "br.gov.caixa.silce.dominio.openjpa.PalpitesSuperSeteValueHandler";
	...
	private Palpites toObjectValue(String value) {
		...
		return new PalpitesSuperSete(value);
