...
public class NSBValueHandler extends AbstractValueHandler {

	public static final String STRATEGY_NAME = "br.gov.caixa.silce.dominio.openjpa.NSBValueHandler";
	...
	public Object toDataStoreValue(ValueMapping vm, Object val, JDBCStore store) {
		if(val instanceof String) {
			return toDataStoreValue(new NSB((String) val));
		}
		return toDataStoreValue((NSB) val);
	}

	private String toDataStoreValue(NSB value) {
		if (value == null) {
			return null;
		}
	...
	private NSB toObjectValue(String value) {
		if (value == null) {
			return null;
		}

		return new NSB(value);
	}
