 ...
 *
 */
public class PalpitesValueHandler extends AbstractValueHandler {

	public static final String STRATEGY_NAME = "br.gov.caixa.silce.dominio.openjpa.PalpitesValueHandler";
	...
	private Palpites toObjectValue(String value) {
		...
		return new PalpitesSequenciais(value);
